...
# Proposed wordingThe wording is relative to [N4562] even if ## General utilities library
...
````in_place` might be instantiated into every object file.
...
## Class `variant`Remove `in_place_type_t`/`in_place_type`/`in_place_index_t`/`in_place_index` from **[variant/synop]** and **[variant/inplace]** 
