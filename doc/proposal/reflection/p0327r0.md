...
An alternative is to define generic functions `std::product_type::size<PT>()` and `std::product_type::get<I>(pt)` using either some wording similar to the one in [P0217R1].
