...
*product type i <sup>th</sup>-element type* 
...
**Replace in 20.4.2.1p3, Assignment by** 

> , and `Ui` be the ith type in a template parameter pack named `UTypes`, where indexing is zero-based
...
### Assignement from a product type with the same number of elements as the tuple  

**Remove in 20.4.2.2p1, Assignment by** 
...
### allocator-extended constructors from a product type with the same number of elements as the tuple  
