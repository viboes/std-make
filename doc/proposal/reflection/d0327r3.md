...
* Do we want the `product_type` customization point in addition to the tuple-like one?

# Acknowledgments

Thanks to the LEWG Toronto participants on the review of the previous revision and for agreing to move this paper to the LEWG.
...
* Consider the possibility to have `product_type` customization points using traits in the rationalle. No wording provided.
