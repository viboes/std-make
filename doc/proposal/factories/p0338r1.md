<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="607">
    <tr>
        ...
        <td width="435"><span style="background-color: #FFFF00">P0338R1</span></td>
    </tr>
    <tr>
...
```c++
    return unique_ptr(a); // with [P0091R3]
```
...
```c++
    return shared_ptr(a); // with [P0091R3]
```
...
Note, with [P0091R3], the following is already possible
...
Thanks to Mike Spertus for its [P0091R3] proposal that help to avoid the factories in some cases. 
...
[P0091R3]: http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0091r3.html "Template parameter deduction for constructors (Rev. 6)"
...
* [P0091R3] - Template parameter deduction for constructors (Rev. 6)

    http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0091r3.html
