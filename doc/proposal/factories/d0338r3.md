<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="607">
    <tr>
        ...
        <td width="435"><span style="background-color: #FFFF00">D0338R3</span></td>
    </tr>
    <tr>
        <td width="172" align="left" valign="top">Date:</td>
        <td width="435">2017-11-14</td>
    </tr>
    <tr>
...
* *TODO* Improve the motivation section. Make it more evident that there is no user advantage and that this is only for library writers. 
* *TODO* Consider removing the overload taking template classes as type-constructors.
...
**Todo**: replace unique_ptr/shared_ptr by optional/expected, or find an algorithm that returns unique_ptr/shared_ptr. Possible algorithm: `transform`?
...
**Todo** Don't use template classes as type-constructors
...
The *ValueOrNone* types proposed in [P0786R0] satisfy these requirement.

While this kind of transformation will not be the more efficient ones for `shared_ptr` and `unique_ptr`, there are applications where this will not be a problem.
