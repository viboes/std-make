...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="607">
    <tr>
        ...
        <td width="435"><span style="background-color: #FFFF00">D0323R1</span></td>
    </tr>
    <tr>
        <td width="172" align="left" valign="top">Date:</td>
        <td width="435">2016-10-03</td>
    </tr>
    <tr>
...
* **TODO** As `variant`, `expected` requires some properties in order to ensure the never-empty warranties. As the error type should be no throw movable, we are always sure to be able to ensure the never-empty warranties.
...
* **TODO** Adapt the constructor and assignment from convertible to `T` and `E`.
...
An alternative will be to make it explicit.
...
## Do we need the member function `value_or`?

`value_or` is something that every *Nullable* can provide. `expected<T,E>` is not exactly a *Nullable*. 
...
**TODO change implementation reference**
