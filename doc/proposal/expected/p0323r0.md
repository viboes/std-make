...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="607">
    <tr>
        ...
        <td width="435"><span style="background-color: #FFFF00">P0323R0</span></td>
    </tr>
    <tr>
...
There is a related proposal for a class including an status and a optional value [P0262R0]. [P0157R0] describes when to use each of the different error report mechanism.  
...
*todo Refine the requirements, as this is not completely true, we need nothrow ...*
