<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="607">
    <tr>
        ...
        <td width="435"><span style="background-color: #FFFF00">D0196R3</span></td>
    </tr>
    <tr>
        <td width="172" align="left" valign="top">Date:</td>
        <td width="435">2017-05-19</td>
    </tr>
    <tr>
...
Revision 3 add a new `nullable::deref` customization point and a lot of algorithms that can be built on top of *Nullable* thaks to this addition, as *Functor* `transform`, *ApplicativeFunctor* `ap`, *Monad* `bind`,  *SumType* `visit`, and some minor algorithms `value_or`and `apply_or`. 
...
## Why `expected<T,E>` can not be considered *Nullable*
...
We could define a *PossiblyValued* type of classes that is more general than *Nullable* and see *Nullable* as a special case of *PossiblyValued* when the non-a-value is a unit type. However the constraint on the default constructor could not be covered by *PossiblyValued* if we would want `expected<T,E>` to be a *PossiblyValued* type.
...
Adding the possibility to dereference a *Nullable* is something natural.
...
* Added `nullable::transform` (*Functor*), `nullable::ap`  (*Applicative*) and `nullable::bind` (*Monad*) [MONADS] when the *Nullable* is also *TypeConstructible* [TYPE_CONSTRUCTIBLE].
...
[MONADS]: http:// "Functors, Applicatives and Monads"

[SUM_TYPE]: http:// "Generic Sum Types"
