...
and `n` denotes `std::experimental::none<N>()`.
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="607">
    ...
    <tr>
        ...
        <td align="left" valign="top"> convertible to bool</td>
...
namespace std {
  ...
  inline namespace fundamentals_v3 {
    ...
    template <template <class ...> class TC>
        constexpr auto none() ->  decltype(none<type_constructor_t<meta::quote<TC>>>()) noexcept;
