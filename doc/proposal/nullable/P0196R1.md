<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="607">
    <tr>
        ...
        <td width="435"><span style="background-color: #FFFF00">D0196R1</span></td>
    </tr>
    <tr>
...
# A generic `none()` factory for *Nullable* types
===============================================
...
means the null value.  This paper proposes a generic `none()` factory for
...
[P0338R0]: https://github.com/viboes/std-make/blob/master/doc/proposal/factories/p0338r0.md "C++ generic factories"
...
* [P0338R0] C++ generic factories
    ...
    https://github.com/viboes/std-make/blob/master/doc/proposal/factories/p0338r0.md
