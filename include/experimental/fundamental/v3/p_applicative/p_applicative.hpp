...
#ifndef JASEL_FUNDAMENTAL_V3_P_APPLICATIVE_P_APPLICATIVE_HPP
#define JASEL_FUNDAMENTAL_V3_P_APPLICATIVE_P_APPLICATIVE_HPP
...
inline namespace fundamental_v3
{
  ...
  template <class T>
    struct is_p_applicative;

  template <class T>
    constexpr bool is_p_applicative_v = is_p_applicative<T>::value;
...
namespace p_applicative
{
  ...
  template <class T>
    struct is_p_applicative : is_base_of<p_applicative::tag, p_applicative::traits<T>> {};
  template <class T>
    struct is_p_applicative<const T> : is_p_applicative<T> {};
  template <class T>
    struct is_p_applicative<volatile T> : is_p_applicative<T> {};
  template <class T>
    struct is_p_applicative<const volatile T> : is_p_applicative<T> {};
