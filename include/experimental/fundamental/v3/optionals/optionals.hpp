...
// Related classes
// * add a pod::optionals. This class works only for POD types as it stores a tuple<Ts..>.
...
// If we make abstraction of the storage, all these classes will define almost the same interface.
//
