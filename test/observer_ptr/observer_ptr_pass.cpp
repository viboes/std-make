...
void test_observer_ptr_explicitly_constructible_from_nullptr_t()
{
...
void test_observer_ptr_implicitly_constructible_from_nullptr_t()
{
	stdex::observer_ptr<int> ptr = nullptr;
	BOOST_TEST(nullptr == ptr);
	BOOST_TEST(ptr == nullptr);
...
void test_observer_ptr_explicitly_constructible_from_ptr()
{
	int                      i = 1;
...
void test_observer_ptr_implicitly_constructible_from_ptr()
{
	int                      i   = 1;
	stdex::observer_ptr<int> ptr = &i;
	BOOST_TEST(&i == ptr.get());
...
void test_observer_ptr_implicitly_copy_constructible()
{
	int                      i = 1;
	stdex::observer_ptr<int> ptr{&i};
	stdex::observer_ptr<int> ptr2 = ptr;
...
void test_observer_ptr_implicitly_move_constructible()
{
	int                      i = 1;
	stdex::observer_ptr<int> ptr{&i};
	stdex::observer_ptr<int> ptr2 = std::move(ptr);
...
void test_observer_ptr_explicit_convertible_to_not_bool()
{
	int                      i = 1;
	stdex::observer_ptr<int> ptr{&i};
	BOOST_TEST(!!ptr);
...
int main()
{
	...
	test_observer_ptr_implicitly_constructible_from_nullptr_t();
	test_observer_ptr_explicitly_constructible_from_nullptr_t();
	test_observer_ptr_implicitly_constructible_from_ptr();
	test_observer_ptr_explicitly_constructible_from_ptr();
	test_observer_ptr_copy_constructible();
	test_observer_ptr_implicitly_copy_constructible();
	test_observer_ptr_move_constructible();
	test_observer_ptr_implicitly_move_constructible();
	...
	test_observer_ptr_explicit_convertible_to_bool();
	test_observer_ptr_explicit_convertible_to_not_bool();
	test_observer_ptr_detach();
